...
} from '@services/redux/messages/messagesApiSlice';
import {
...
export default function MessageInputBar() {
  ...
  return (
    <Container maxW='container.sm' display='flex' flex={1} flexDirection='column' my={-2}>
      <form
        ...
        <HStack>
          <VStack spacing={0} w='100%'>
            ...
            <Input
              ...
              autoComplete='off'
              borderTopRadius={inputBarMode == 'EDIT' && editableMessage ? 0 : undefined}
            />
          </VStack>
          <IconButton
            type='submit'
            ...
            alignSelf='flex-end'
            mb={6}
            icon={inputBarMode == 'COMMON' ? <IoSend size={20} /> : <HiCheck size={25} />}
          />
        </HStack>
      </form>
    </Container>
