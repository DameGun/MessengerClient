import { Container, Box, FormControl, FormLabel, Heading, Input, FormErrorMessage, Button, Link as ChakraUiLink, Text, useDisclosure, Alert, AlertIcon, AlertTitle, CloseButton } from "@chakra-ui/react";
                        ...
                        <Form style={{ width: 300}}>
                            ...
                            <Text fontSize={14} mt={2}>
                                ...
                                <ChakraUiLink 
                                    ...
                                    to='/login'
                                    replace
                                >Click here to login</ChakraUiLink>
                            </Text>
                            <Button 
                                mt={4} 
                                width='100%' 
