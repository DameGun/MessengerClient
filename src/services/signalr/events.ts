...
export function deleteChatMessageNotification(deleteChatMessageNotificationCallback: (chatId: string, messageId: string) => void) {
    signalrConnection.on('DeleteNotification', (chatId, messageId) => {
        deleteChatMessageNotificationCallback(chatId, messageId);
    })
}

export function editChatMessage(message: Partial<ChatMessageUpdate>, connectionId: string, chatId: string) {
...
export function editChatMessageNotification(
    ...
    signalrConnection.on('EditNotification', (accountId, chatId, messageId, text, image) => {
